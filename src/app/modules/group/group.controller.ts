...
const updateGroup = catchAsync(async (req, res) => {
  const userId = req.user?.userId
  const { groupId } = req.params
  const result = await GroupServices.updateGroupIntoDB(userId, groupId, req.body)
...
const getGroupPosts = catchAsync(async (req, res) => {
  const userId = req.user?.userId
  const { groupId } = req.params
  const result = await GroupServices.getGroupPostsFromDB(userId, groupId, req.query)
...
const approveJoinRequest = catchAsync(async (req, res) => {
  ...
  const result = await GroupServices.approveJoinRequestIntoDB(userId, groupId, requestUserId)
